...
import com.ageofwar.utils.Assets; // Assuming Assets class manages loading
...
public class AgeOfWarGame extends Game {
    ...
    public Assets assets; // Asset manager instance
    ...
    public void create () {
        ...
        assets = new Assets(); // Initialize and load assets
