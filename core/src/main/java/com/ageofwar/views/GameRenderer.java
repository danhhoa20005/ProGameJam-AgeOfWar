...
public class GameRenderer implements Disposable {
    ...
    // --- XÓA CÁC HẰNG SỐ MÀU ĐÃ CHUYỂN SANG RENDERER CON ---
    ...
    // --- XÓA CÁC PHƯƠNG THỨC VẼ ĐÃ CHUYỂN SANG RENDERER CON ---
    // private <T extends Entity> void drawEntityPlaceholders(...) { ... }
    // private <T extends Entity> void drawHealthBars(...) { ... }
    // private void drawBasePlaceholder(...) { ... }
    // private void drawBaseHealthBar(...) { ... }
    // private void drawHealthBar(...) { ... } // Đã chuyển sang BaseRenderer
